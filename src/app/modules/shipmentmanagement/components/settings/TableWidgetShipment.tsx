...
const TablesWidgetShipment: React.FC<Props> = ({ shipment,className}) => {
    return (
      ...
      <div className='card-header border-0 pt-5'>
        ...
        >
          <a
            ...
            data-bs-target='#kt_modal_addroute'
          >
            <KTSVG path='/media/icons/duotune/arrows/arr075.svg' className='svg-icon-3' />
            Add Shipment
          </a>
          <ShipmentTable shipmentData={undefined}/>
        </div>
      </div>
      {/* end::Header */}
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>Shipment Id</th>
                <th className='min-w-150px'>WayBillNumber</th>
                <th className='min-w-150px'>FirstName</th>
                {/* <th className='min-w-140px'>Company</th> */}
                <th className='min-w-120px'>LastName</th>
