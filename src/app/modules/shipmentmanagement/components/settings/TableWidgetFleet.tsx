...
const TablesWidgetFleet: React.FC<Props> = ({ fleet,className}) => {
    return (
    <div className={`card ${className}`}>
      {/* begin::Header */}
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Fleet</span>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bolder text-muted'>
                ...
                <th className='min-w-150px'>Fleet Name</th>
                <th className='min-w-150px'>Fleet Make</th>
                <th className='min-w-150px'>Fleet Type</th>
