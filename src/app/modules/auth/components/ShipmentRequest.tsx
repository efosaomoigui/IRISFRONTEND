...
export function ShipmentRequest() {
      ...
      setTimeout(() => {
        register(
          ...
          .catch(() => {
            setLoading(false)
            setSubmitting(false)
            setStatus('Request process has broken')
          })
      }, 1000)
    },
  })
  ...
  return (
    <form
      ...
      noValidate
      id='kt_shipment_request_form'
      onSubmit={formik.handleSubmit}
    >
      {/* begin::Heading */}
      <div className='mb-10 text-center'>
        {/* begin::Title */}
        <h1 className='text-dark mb-3'>Freight/Truck/Shipment Request</h1>
        {/* end::Title */}

        {/* begin::Link */}
        <div className='text-gray-400 fw-bold fs-4'>
          Make A Quick Request For Your Shipment Requirements
      ...
      <div className='mb-10 fv-row' data-kt-password-meter='true'>
        <div className='mb-1'>
          <label className='form-label fw-bolder text-dark fs-6'>Kindly Provide Shipment Details</label>
