...
import { IAddWalletModel } from '../../Models/WalletInterfaces'


type Props = {
    className: string
    addwallet: IAddWalletModel[]
}
  
const TablesWidgetAddWallet: React.FC<Props> = ({ addwallet,className}) => {
    return (
      ...
      <div className='card-body py-3'>
        ...
        <div className='table-responsive'>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            {/* begin::Table body */}
            <tbody>
                {addwallet.map((addwallet) => (
                <tr key={addwallet.WalletId}>
                  <td>
                    <div className='form-check form-check-sm form-check-custom form-check-solid'>
                      <input
                    ...
                    <div className='d-flex align-items-center'>
                      ...
                      <div className='d-flex justify-content-start flex-column'>
                        <a href='#' className='text-dark fw-bolder text-hover-primary fs-6'>
                            {addwallet.firstName} {addwallet.lastName}
                          {/* Fleet Manager */}
                        </a>
